...
Namespace AreaProtocol
    ...
    Public Class EssentialA1x10
        ...
        Public Function reorderList() As List(Of NodeComplete)
            Try
                ...
                AreaCommon.log.track("EssentialA1x10.reorderList", "Begin")
                ...
                AreaCommon.log.track("EssentialA1x10.reorderList", "Completed")

                Return result
            Catch ex As Exception
                AreaCommon.log.track("EssentialA1x10.reorderList", ex.Message, "fatal")
    ...
    ''' <summary>
    ''' This class contain all element to manage a A1x10 command
    ''' </summary>
    Public Class A1x10
        ...
        Public Class RequestModel : Implements IRequestModel
            ...
            Public Property content As New EssentialA1x10
        ...
        Public Class RequestResponseModel
            ...
            Public Property common As CommonRequest Implements IRequestModel.common
                ...
                End Set
            End Property
            Public Property content As EssentialA1x10
                Get
                    Return _Base.content
                End Get
                Set(value As EssentialA1x10)
                    _Base.content = value
                End Set
            End Property
        ...
        Public Class RecoveryState
            ...
            Public Shared Function fromRequest(ByRef value As RequestModel, ByVal transactionChainRecord As CHCCommonLibrary.AreaCommon.Models.General.IdentifyLastTransaction) As Boolean
                Try
                    ...
                    End If
                    If proceed Then
                        proceed = IOFast(Of EssentialA1x10).save(completefileName, value.content)
                    End If
