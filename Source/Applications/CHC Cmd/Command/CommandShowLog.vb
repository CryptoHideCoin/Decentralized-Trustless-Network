        ...
        Private Function CommandModel_run() As Boolean Implements CommandModel.run
            Try
                ...
                If _Command.haveParameter("securityKey") Then
                    parameterSecurityKey = "--password:" & _Command.parameters("securityKey".ToLower).value
                End If
                If _Command.haveParameter("mode") Then
                    parameterMode = "--mode:" & _Command.parameters("mode").value
                Else
                    parameterMode = "--mode:Console"
                End If
                If _Command.haveParameter("address") Then
                    parameterPassword = "--address:" & _Command.parameters("address").value
                Else
