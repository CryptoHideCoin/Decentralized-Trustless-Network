...
#End If
                            'MessageBox.Show("the 'Newtonsoft.Json.dll' release is wrong. Current is " & FileVersionInfo.GetVersionInfo(singleFile).ProductVersion, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
