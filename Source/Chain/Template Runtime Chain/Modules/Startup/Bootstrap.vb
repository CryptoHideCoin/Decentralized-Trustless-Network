...
Namespace AreaBootstrap
    ...
    Module Bootstrap
        ...
        '        If IO.Directory.Exists(AreaCommon.paths.transactionChain.path) Then
        ...
        '        If IO.Directory.Exists(AreaCommon.paths.transactionChain.ledger) Then
        ...
        '        Dim webReader As New ProxySimplyWS(Of General.BooleanModel)
        '        Dim result As General.BooleanModel
        ...
        '        Dim webReader As New ProxyWS(Of List(Of AreaChain.NodeList.NodeAtom))
