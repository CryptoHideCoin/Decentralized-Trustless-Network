    ...
    Public Class SidechainConfigurationEngine
        ...
        Public Function init() As Boolean
            ...
            Try
                ...
                For Each singleFile In IO.Directory.GetFiles(AreaCommon.paths.workDefine.sideChainContracts)
        ...
        Public Function getData(ByVal id As String) As AreaCommon.Models.Define.ChainResponseModel
            ...
            Try
                ...
                If _Keys.ContainsKey(id) Then
                    ...
                    pathFile = IO.Path.Combine(AreaCommon.paths.workDefine.sideChainContracts, id & ".Definition")
