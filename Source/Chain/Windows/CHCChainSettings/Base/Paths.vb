...
Namespace AreaSystem
    ...
    Public Class Paths
        ...
        Public Const settingFileName As String = "AdminClient.Settings"
        ...
        Public Const countersFolderName As String = "Counters"
        Public Const eventsFolderName As String = "Events"
        ...
        Public Function init() As String
            Try
                If (pathBaseData.Trim.Length > 0) Then
                    ...
                    pathCounters = IO.Path.Combine(pathSystem, countersFolderName)
                    pathEvents = IO.Path.Combine(pathSystem, eventsFolderName)

                    If Not IO.Directory.Exists(pathKeystore) Then
                        IO.Directory.CreateDirectory(pathKeystore)
                    End If
