...
Namespace AreaProtocol
    ...
    Public Class A0x2
        ...
        Public Class Manager
            ...
            ''' <returns></returns>
            Public Shared Function createRequest(ByVal yellowPaperParameter As String) As String
                Try
                    Dim data As New RequestModel

                    AreaCommon.log.track("A0x2Manager.createRequest", "Begin")
                    ...
                    If saveTemporallyRequest(data) Then
                        AreaCommon.log.track("A0x2Manager.createRequest", "request - Saved")
                ...
                Catch ex As Exception
                    ...
                    AreaCommon.log.track("A0x2Manager.createRequest", ex.Message, "fatal")
                Finally
                    AreaCommon.log.track("A0x2Manager.createRequest", "Completed")
                End Try
