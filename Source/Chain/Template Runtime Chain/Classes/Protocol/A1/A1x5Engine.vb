        ...
        Public Class Manager
            ...
            Private Function writeDataIntoLedger(ByVal contentStatePath As String) As CHCCommonLibrary.AreaCommon.Models.General.IdentifyRecordLedger
                Try
                    ...
                    TransactionChainLibrary.AreaEngine.Ledger.State.StateEngine.writeDataContent(contentStatePath, data.privacyPolicyDocument, AreaCommon.state.currentBlockLedger.currentRecord.detailInformation)
