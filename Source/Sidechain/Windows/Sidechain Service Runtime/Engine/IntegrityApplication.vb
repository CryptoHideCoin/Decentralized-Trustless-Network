    ...
    Public Shared Function executeRepairNewton(ByVal fileName As String) As Boolean
        Try
            If fileName.Contains("12.0.0") Then
                Shell(IO.Path.Combine(My.Application.Info.DirectoryPath, "CHCRepairNewtown.exe") & " -copy --repair:useNewer")
            Else
                Shell(IO.Path.Combine(My.Application.Info.DirectoryPath, "CHCRepairNewtown.exe") & " -copy --repair:useOlder")
            End If
