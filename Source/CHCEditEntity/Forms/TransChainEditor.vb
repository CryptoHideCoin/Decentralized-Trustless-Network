...
Public Class TransChainEditor
    ...
    Private Class ResultSearchCryptoAsset
        ...
        Public [type] As CHCDefinitionEngineLibrary.Models.CryptoAssetModel.EnumEntityType
        Public providesPremined As Boolean
        Public symbol As String

    End Class

    Private _Data As CHCDefinitionEngineLibrary.Models.TransChainDefinitionModel
    Private _Engine As New CHCCommonLibrary.CHCEngines.Common.BaseFileDB(Of CHCDefinitionEngineLibrary.Models.TransChainDefinitionModel)
    ...
    Private Function readRemoteData() As Boolean
        ...
        Try
            ...
            Dim pws As New CHCCommonLibrary.CHCEngines.Communication.ProxyWS(Of CHCDefinitionEngineLibrary.Models.TransChainDefinitionModel)
        ...
        Try
            ...
            If radioButtonLocal.Checked Then
                ...
                If Not readData() Then
                    ...
                    _Data = New CHCDefinitionEngineLibrary.Models.TransChainDefinitionModel
    ...
    Private Sub updateDataRemote(Optional ByVal forceNewName As String = "")
        ...
        Try
            ...
            Dim pws As New CHCCommonLibrary.CHCEngines.Communication.ProxyWS(Of CHCDefinitionEngineLibrary.Models.TransChainDefinitionRequestModel)
    ...
    Private Function getCryptoAssetInfo(ByVal path As String, ByVal fileName As String) As ResultSearchCryptoAsset
        ...
        Dim engine As New CHCDefinitionEngineLibrary.CHCEngines.CryptoAssetDefinitionEngine(path)
    ...
    Private Function getCryptoAssetDefinitions() As List(Of ResultSearchCryptoAsset)
        ...
        Dim detailpws As New CHCCommonLibrary.CHCEngines.Communication.ProxyWS(Of CHCDefinitionEngineLibrary.Models.CryptoAssetModel)
    ...
    Private Sub loadCryptoAssetList()
        ...
        If radioButtonLocal.Checked Then
            ...
            For Each fileInformation In filesResult
                ...
                If (typeValue.SelectedIndex + 1 = CHCDefinitionEngineLibrary.Models.TransChainDefinitionModel.EnumTransChainType.mainPlatform) Then

                    If (item.type = CHCDefinitionEngineLibrary.Models.CryptoAssetModel.EnumEntityType.coin) Then
                ...
                ElseIf (typeValue.SelectedIndex + 1 = CHCDefinitionEngineLibrary.Models.TransChainDefinitionModel.EnumTransChainType.crowdfund) Then

                    If (item.type = CHCDefinitionEngineLibrary.Models.CryptoAssetModel.EnumEntityType.token) Then
    ...
    Private Sub compileAllData()
        ...
        Try
            ...
            If (_Data.mode = CHCDefinitionEngineLibrary.Models.TransChainDefinitionModel.EnumTransChainMode.official) Then

                modeValue.SelectedIndex = 0

            ElseIf (_Data.mode = CHCDefinitionEngineLibrary.Models.TransChainDefinitionModel.EnumTransChainMode.testNet) Then
            ...
            If (_Data.type = CHCDefinitionEngineLibrary.Models.TransChainDefinitionModel.EnumTransChainType.mainPlatform) Then

                typeValue.SelectedIndex = 0

            ElseIf (_Data.type = CHCDefinitionEngineLibrary.Models.TransChainDefinitionModel.EnumTransChainType.crowdfund) Then
    ...
    Private Sub modeValue_SelectedIndexChanged(sender As Object, e As EventArgs) Handles modeValue.SelectedIndexChanged
        ...
        If (modeValue.SelectedIndex = -1) Then
            ...
            _Data.mode = CHCDefinitionEngineLibrary.Models.TransChainDefinitionModel.EnumTransChainMode.notDefined

        ElseIf (modeValue.SelectedIndex = 0) Then

            _Data.mode = CHCDefinitionEngineLibrary.Models.TransChainDefinitionModel.EnumTransChainMode.official

        Else

            _Data.mode = CHCDefinitionEngineLibrary.Models.TransChainDefinitionModel.EnumTransChainMode.testNet
    ...
    Private Sub typeValue_SelectedIndexChanged(sender As Object, e As EventArgs) Handles typeValue.SelectedIndexChanged
        ...
        If (typeValue.SelectedIndex = -1) Then
            ...
            _Data.type = CHCDefinitionEngineLibrary.Models.CryptoAssetModel.EnumEntityType.notDefined

        ElseIf (typeValue.SelectedIndex = 0) Then

            _Data.type = CHCDefinitionEngineLibrary.Models.CryptoAssetModel.EnumEntityType.coin

        Else

            _Data.type = CHCDefinitionEngineLibrary.Models.CryptoAssetModel.EnumEntityType.token
