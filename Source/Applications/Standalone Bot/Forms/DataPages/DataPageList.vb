Public Class DataPageList
    ...
    Private Function getRowData(ByVal fileName As String, ByVal dataComplete As Boolean) As SingleDataPage
        ...
        newData.showDate = fileName.Replace(".CurrentCounterDay", "")
        newData.showDate = newData.showDate.Replace(AreaCommon.IO.dayCounterPath, "")
        ...
        If dataComplete Then
            With CHCCommonLibrary.AreaEngine.DataFileManagement.Json.IOFast(Of AreaCommon.Models.Journal.DayCounterModel).read(newData.completeFileName)
                If (.apy <> 0) Then
