...
Public Class Main
    ...
    Private Function addSinglePackage(ByVal fileName As String, ByVal dirName As String, ByVal releaseValue As String) As PackageRelease
        ...
        If singleFile.fileName.ToUpper.StartsWith("CHC") Then

            singleFile.serviceName = StrConv(singleFile.fileName.Replace(".exe", "").Replace("chc", "").Replace("service", "").Replace("library", "").Replace(".dll", ""), VbStrConv.ProperCase)
