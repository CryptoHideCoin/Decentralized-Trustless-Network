        ...
        Public Function GetValue(ByVal securityToken As String) As RegistryListResponseModel
            ...
            Try
                If (AreaCommon.Main.serviceInformation.currentStatus = InternalServiceInformation.EnumInternalServiceState.started) Then
                    AreaCommon.Main.environment.log.trackEnter("RegistryListController.GetValue", ownerId, $"token={securityToken}", CHCModelsLibrary.AreaModel.Log.AccessTypeEnumeration.api)
            ...
            Finally
                If enter Then
                    AreaCommon.Main.environment.log.trackExit("RegistryListController.GetValue", ownerId)
                End If
            End Try
