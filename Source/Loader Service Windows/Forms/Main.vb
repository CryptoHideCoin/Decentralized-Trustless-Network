        ...
        Try
            ...
            With AreaCommon.settings.data
                ...
                Else
                    ...
                    .useTrack = LogEngine.TrackRuntimeModeEnum.dontTrack

                End If

                If useEventRegistry.Checked Then

                    .useEventRegistry = LogEngine.TrackRuntimeModeEnum.trackAllRuntime

                Else

                    .useEventRegistry = LogEngine.TrackRuntimeModeEnum.dontTrack
