...
Namespace AreaCommon.Command
    ...
    ''' </summary>
    Public Class CommandStatusServe : Implements CommandModel
        ...
        Private Function getStatus() As Boolean
            Try
                ...
                If proceed Then
                    remote.url = buildURL("/service/information/?securityToken=" & _SecurityToken)
                End If
                If proceed Then
                ...
                If proceed Then
                    ...
                    Console.WriteLine("The service status is " & status)
                End If

                Return proceed
            Catch ex As Exception
                Console.WriteLine("Error during getStatus - " & ex.Message)
            ...
            Try
                ...
                If proceed Then
                    If Not getStatus() Then
                        Console.WriteLine("Problem during read the Status command!")
