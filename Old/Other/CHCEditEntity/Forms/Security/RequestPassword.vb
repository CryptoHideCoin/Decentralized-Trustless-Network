Public Class RequestPassword
    ...
    Private Sub useKeyLabel_CheckedChanged(sender As Object, e As EventArgs)
    ...
    Private Sub showCharacterValue_Click(sender As Object, e As EventArgs) Handles showCharacterValue.Click
