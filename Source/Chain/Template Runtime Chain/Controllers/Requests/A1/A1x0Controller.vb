...
Namespace Controllers
    ...
    ' GET: API/{GUID service}/Requests/A1x0Controller
    <Route("RequestApi")>
    Public Class A1x0Controller
        ...
        ''' <summary>
        ''' This API (get method) provide to return a request model A1x0 of a hashValue request
        ''' </summary>
        ''' <param name="hashValue"></param>
        ''' <returns></returns>
        Public Function getValue(ByVal hashValue As String) As AreaProtocol.A1x0.RequestResponseModel
            Dim result As New AreaProtocol.A1x0.RequestResponseModel
            Try
                AreaCommon.log.track("A1x0Controller.getValue", "Begin")
            ...
            Catch ex As Exception
                ...
                AreaCommon.log.track("A1x0Controller.getValue", "An error occurrent during execute: " & ex.Message, "fatal")
            End Try
