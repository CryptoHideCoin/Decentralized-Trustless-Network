...
Namespace AreaCommon.Command
    ...
    ''' <summary>
    ''' This class manage the command Journal
    ''' </summary>
    Public Class CommandJournal : Implements CommandModel
        ...
        Private Function readParameters() As Boolean
            Try
                ...
                End If
                If _Command.haveParameter("rotate") Then
                    _ParameterCommand = "rotate"
                End If
...
#Enable Warning BC42024
        ...
        ''' <summary>
        ''' This method provide to rotate journal
        ''' </summary>
        ''' <returns></returns>
        Private Function rotate() As Boolean
            Try
                Dim remote As New ProxyWS(Of BaseRemoteResponse)
                Dim proceed As Boolean = True

                If proceed Then
                    remote.url = buildURL($"/administration/maintenance/cleanJournal/?securityToken={_SecurityToken}")
                End If
                If proceed Then
                ...
                End If
                If proceed Then
                    Console.WriteLine($"Delete old journal Executed")
                End If
            ...
            Try
                ...
                If proceed Then
                    Select Case _ParameterCommand.ToLower()
                        Case "rotate".ToLower()
                            If Not rotate() Then
                                Console.WriteLine("Problem during delete old journal")
