        ...
        Public Function PutValue(ByVal securityToken As String, ByVal blockNumber As String) As BaseRemoteResponse
            ...
            Try
                If (AreaCommon.Main.serviceInformation.currentStatus = InternalServiceInformation.EnumInternalServiceState.started) Then
                    AreaCommon.Main.environment.log.trackEnter("LogBlockDelete.PutValue", ownerId, $"token={securityToken} blockNumber={blockNumber}", CHCModelsLibrary.AreaModel.Log.AccessTypeEnumeration.api)
            ...
            Finally
                If enter Then
                    AreaCommon.Main.environment.log.trackExit("LogBlockDelete.PutValue", ownerId)
                End If
            End Try
