    ...
    Module StartUp
        ...
        Private Sub copyCommandParameters(ByRef command As ManageCommandLine)
            ...
            Try
                ...
                With command.parameters.data
                    ...
                    End If
                    If (.serviceLoader.url.Trim.Length > 0) Then

                        settings.data.serviceLoader.useSecure = .serviceLoader.useSecure
                        settings.data.serviceLoader.url = .serviceLoader.url
                        settings.data.serviceLoader.certificate = .serviceLoader.certificate
                    ...
                    If (.recallLoader) Then settings.data.recallLoader = .recallLoader
        ...
        Private Sub recallStarter()
            ...
            Try
                ...
                handShakeEngine.url = AreaCommon.settings.data.serviceLoader.composeURL("/api/v1.0/System/handShake/?serviceAdministrative=true&serviceEngine=false&serviceUpdate=false&certificateValue=" & AreaCommon.settings.data.serviceLoader.certificate)
        ...
        Sub run(Optional ByVal saveSettings As Boolean = False)
            ...
            Try
                ...
                AreaApplication.visionPapers.init(paths.workDefine.visionPapers)
                AreaApplication.whitePapers.init(paths.workDefine.whitePapers)
                AreaApplication.yellowPapers.init(paths.workDefine.yellowPapers)
                AreaApplication.privacyPapers.init(paths.workDefine.privacyPapers)
                AreaApplication.termsAndConditionsPapers.init(paths.workDefine.termsAndConditionsPapers)
                ...
                If settings.data.recallLoader Then
                    recallStarter()
                End If
