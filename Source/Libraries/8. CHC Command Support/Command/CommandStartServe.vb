...
Namespace AreaCommon.Command
    ...
    ''' </summary>
    Public Class CommandStartServe : Implements Models.CommandModel
        ...
        Private Function CommandModel_run() As Boolean Implements Models.CommandModel.run
            Try
                ...
                End If
                If (parameterServiceName.Length > 0) Then
                ...
                Select Case parameterServiceName.ToLower()
                    ...
                    Case "primary"
                        ...
                        parameters = parameterDataPath & " " & parameterPassword
                    Case Else
                        RaiseEvent WriteLine($"Error: {parameterServiceName} service not managed")
                ...
                If IO.Directory.Exists(path) Then
                    ...
                    Else
                        RaiseEvent Process(path, $"-force {parameters}")
