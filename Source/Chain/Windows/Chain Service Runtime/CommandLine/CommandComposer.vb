        ...
        Public Function addNewParameter(ByVal value As String) As Boolean
            Try
                ...
                If parameters.ContainsKey(newParameter.key) Then
                    MessageBox.Show("Duplicate parameters", "Errors", MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    Public Class CommandComposer
        ...
        Public Function run(ByRef elements As List(Of String)) As CommandArguments
            ...
            Try
                For Each item In elements
                    If isCommand(item) Then
                        If (result.code <> CommandEnumeration.undefined) Then
                            MessageBox.Show("To more command", "Errors", MessageBoxButtons.OK, MessageBoxIcon.Error)
                        Else
                            If Not result.extractCodeFromString(item) Then
                                MessageBox.Show("Command not recognized", "Errors", MessageBoxButtons.OK, MessageBoxIcon.Error)
                            End If
                        End If
                    Else
                ...
                End If
            Catch ex As Exception
                MessageBox.Show("Problem during decode a parameters " & ex.Message, "Errors", MessageBoxButtons.OK, MessageBoxIcon.Error)
            End Try
