...
Public Class Main
    ...
    Private Sub showCertificateData()
        ...
        With AreaCommon.settings.data
            ...
            certificateMasternodeStart.Text = .serviceLoader.certificate
    ...
    Private Sub Main_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            With AreaCommon.settings.data
                ...
                If .serviceLoader.useSecure Then protocolMasternodeStart.SelectedIndex = 1 Else protocolMasternodeStart.SelectedIndex = 0
                If .serviceRuntime.useSecure Then protocolMasternodeEngine.SelectedIndex = 1 Else protocolMasternodeEngine.SelectedIndex = 0

                masternodeStartUrl.Text = .serviceLoader.url
    ...
    Private Sub loadDataIntoSettings()
        ...
        Try
            ...
            With AreaCommon.settings.data
                ...
                .serviceLoader.useSecure = (protocolMasternodeStart.SelectedIndex > 0)
                .serviceLoader.url = masternodeStartUrl.Text
                .serviceLoader.certificate = certificateMasternodeStart.Text
