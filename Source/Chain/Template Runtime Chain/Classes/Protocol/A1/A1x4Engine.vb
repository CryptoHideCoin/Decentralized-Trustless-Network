...
'                With AreaCommon.state.runtimeState.getDataChainByName(value.chainName)
...
'                    If engine.read() Then
'                        AreaCommon.state.runtimeState.getDataChainByName(chainName).priceLists.value = engine.data
'                    End If
