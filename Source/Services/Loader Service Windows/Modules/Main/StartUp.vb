    ...
    Module StartUp
        ...
        Sub runAdminService()
            ...
            Try
                ...
                If settings.data.debugMode Then
                    ...
                    Return
                End If
                If testService(settings.data.serviceAdmin.useSecure, settings.data.serviceAdmin.url) Then Return

                If Not executeExternalApplication(moduleMain.adminFileService, "/NoConsoleMessage /RecallStarter /MasternodeStartURL:localhost:" & settings.data.portNumber & " /ServiceLoaderCertificate:" & settings.data.serviceAdmin.certificate & " /UseLastSettings") Then
                    Return
                End If
        ...
        Sub runUpdateManager()
            ...
            Try
                ...
                If Not executeExternalApplication(moduleMain.updateFileService, "/DataPath:" & paths.directoryData & " /NoConsoleMessage /RecallLoader /RecallPort:" & settings.data.portNumber & " /ServiceLoaderCertificate:" & settings.data.serviceAdmin.certificate & " /UseLastSettings") Then
                    closeApplication()
                End If
                ...
                Do While Not state.updateStateData.connection And (Now.Subtract(timeStart).TotalSeconds < 31)
                    Threading.Thread.Sleep(500)
                    Application.DoEvents()
                Loop

                If Not state.updateStateData.connection Then
        ...
        Private Sub runEngine(ByRef service As AppState.ServiceStatus)
            ...
            Try
                ...
                If Not executeExternalApplication(service.applicationName, "/NoConsoleMessage /RecallStarter /MasternodeStartURL:localhost:" & settings.data.portNumber & " /ServiceLoaderCertificate:" & settings.data.serviceAdmin.certificate & " /UseLastSettings") Then
                    Return
                End If
