        ...
        Public Function GetValue(ByVal securityToken As String, ByVal index As String) As RegistryStreamResponseModel
            ...
            Try
                If (AreaCommon.Main.serviceInformation.currentStatus = InternalServiceInformation.EnumInternalServiceState.started) Then
                    AreaCommon.Main.environment.log.trackEnter("RegistryPageController.GetValue", ownerId, $"token={securityToken}&index={index}", CHCModelsLibrary.AreaModel.Log.AccessTypeEnumeration.api)
            ...
            If enter Then
                AreaCommon.Main.environment.log.trackExit("RegistryPageController.GetValue", ownerId, $"token={securityToken}")
            End If
