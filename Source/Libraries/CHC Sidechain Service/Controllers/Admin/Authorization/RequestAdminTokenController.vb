...
Namespace Controllers
    ...
    ' GET: api/{GUID service}/administration/security/requestAdminSecurityTokenController
    ...
    Public Class RequestAdminSecurityTokenController
        ...
        ''' <returns></returns>
        Public Function GetValue(ByVal signature As String) As RequestAdminSecurityTokenModel
            Dim result As New RequestAdminSecurityTokenModel
