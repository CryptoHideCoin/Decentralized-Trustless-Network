...
Public Class CryptoAssetEditor
    ...
    Private _Data As Models.CryptoAssetModel
    Private _Engine As New CHCCommonLibrary.CHCEngines.Common.BaseFileDB(Of Models.CryptoAssetModel)
    ...
    Private Function readRemoteData() As Boolean
        ...
        Try
            ...
            Dim pws As New CHCCommonLibrary.CHCEngines.Communication.ProxyWS(Of Models.CryptoAssetModel)
        ...
        Try
            ...
            If radioButtonLocal.Checked Then
                ...
                If Not readData() Then
                    ...
                    _Data = New Models.CryptoAssetModel
    ...
    Private Sub updateDataRemote(Optional ByVal forceNewName As String = "")
        ...
        Try
            ...
            Dim pws As New CHCCommonLibrary.CHCEngines.Communication.ProxyWS(Of Models.CryptoAssetRequestModel)
    ...
    Private Sub compileAllData()
        ...
        Try
            ...
            If (_Data.type = Models.CryptoAssetModel.EnumEntityType.coin) Then

                typeValue.SelectedIndex = 0

            ElseIf (_Data.type = Models.CryptoAssetModel.EnumEntityType.token) Then
