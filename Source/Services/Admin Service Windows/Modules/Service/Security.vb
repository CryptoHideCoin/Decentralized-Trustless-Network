        ...
        Public Function checkInAllCertification(ByVal value As String) As Boolean
            ...
            Try
                ...
                ElseIf (AreaCommon.settings.data.serviceRuntime.certificate.CompareTo(value) = 0) Then
                    Return True
                ElseIf (AreaCommon.settings.data.serviceLoader.certificate.CompareTo(value) = 0) Then
                    Return True
                Else
                    Return False
                End If
        ...
        Public Function changeCertificate(ByVal value As AreaCommon.Models.Security.changeCertificate) As Boolean
            ...
            Try
                ...
                Select Case value.typeCommunication
                    ...
                    Case AreaCommon.Models.Security.enumOfService.runTime : AreaCommon.settings.data.serviceLoader.certificate = value.newCertificate
