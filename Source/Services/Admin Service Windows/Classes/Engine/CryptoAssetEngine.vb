    ...
    Public Class CryptoAssetEngine
        ...
        Public Function init() As Boolean
            ...
            Try
                ...
                For Each singleFile In IO.Directory.GetFiles(AreaCommon.paths.workDefine.assets)
        ...
        Public Function getData(ByVal id As String) As AreaCommon.Models.Define.CryptoAssetResponseModel
            ...
            Try
                ...
                If _Keys.ContainsKey(id) Then
                    ...
                    pathFile = IO.Path.Combine(AreaCommon.paths.workDefine.assets, id & ".Definition")
