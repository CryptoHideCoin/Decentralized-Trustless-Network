...
Namespace AreaProtocol
    ...
    Public Class A0x1
        ...
        Public Class RecoveryState
            ...
            Public Shared Function fromRequest(ByRef value As RequestModel, ByVal transactionChainRecord As CHCCommonLibrary.AreaCommon.Models.General.IdentifyLastTransaction) As Boolean
                Try
                    ...
                    Dim hashContent As String = HashSHA.generateSHA256(value.whitePaper)

                    AreaCommon.log.track("RecoveryState.fromRequest", "Begin")

                    If proceed Then
                        proceed = AreaCommon.state.runtimeState.addNetworkProperty(AreaCommon.DAO.DBNetwork.MainPropertyID.whitePaper, value.whitePaper, transactionChainRecord, hashContent, False)
                    End If
                    If proceed Then
        ...
        Public Class Manager
            ...
            ''' <returns></returns>
            Public Shared Function createInternalRequest(ByVal whitePaperParameter As String) As String
                Try
                    Dim data As New RequestModel

                    AreaCommon.log.track("A0x1Manager.createInternalRequest", "Begin")
                    ...
                    If saveTemporallyRequest(data) Then
                        AreaCommon.log.track("A0x1Manager.createInternalRequest", "request - Saved")
                ...
                Catch ex As Exception
                    ...
                    AreaCommon.log.track("A0x1Manager.createInternalRequest", ex.Message, "fatal")
                Finally
                    AreaCommon.log.track("A0x1Manager.createInternalRequest", "Completed")
                End Try
