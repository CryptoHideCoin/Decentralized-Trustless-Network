    ...
    Private Sub Main_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            With AreaCommon.settings.data
                ...
                protocolServiceAdmin.SelectedIndex = .protocolSecureServiceAdmin
                serviceAdminUrl.Text = .urlServiceAdmin
                certificateServiceAdmin.Text = .certificateServiceAdmin
    ...
    Private Sub loadDataIntoSettings()
        ...
        Try
            ...
            With AreaCommon.settings.data
                ...
                .protocolSecureServiceAdmin = protocolServiceAdmin.SelectedIndex
                .urlServiceAdmin = serviceAdminUrl.Text
                .certificateServiceAdmin = certificateServiceAdmin.Text
