    ...
    Public Class RefundPlanEngine
        ...
        Public Function init() As Boolean
            ...
            Try
                ...
                For Each singleFile In IO.Directory.GetFiles(AreaCommon.paths.workDefine.refundPlans)
        ...
        Public Function getData(ByVal id As String) As AreaCommon.Models.Define.RefundPlanResponseModel
            ...
            Try
                ...
                If _Keys.ContainsKey(id) Then
                    ...
                    pathFile = IO.Path.Combine(AreaCommon.paths.workDefine.refundPlans, id & ".Definition")
