...
Namespace AreaProtocol
    ...
    ''' <summary>
    ''' This class contain the minimal data essential A1x8 (Registrate )
    ''' </summary>
    Public Class EssentialA1x8

        Public Property closeBlock As Boolean = False
        ...
        Public Overrides Function toString() As String
            ...
            result += dataLastRecord.ToString()
    ...
    Public Class A1x8
        ...
        Public Class RequestModel : Implements IRequestModel
            ...
            Public Property content As New EssentialA1x8
        ...
        Public Class RequestResponseModel
            ...
            Public Property common As CommonRequest Implements IRequestModel.common
                ...
                End Set
            End Property
            Public Property content As EssentialA1x8
                Get
                    Return _Base.content
                End Get
                Set(value As EssentialA1x8)
                    _Base.content = value
                End Set
            End Property
        ...
        Public Class RecoveryState
            ...
            Public Shared Function fromRequest(ByRef value As RequestModel, ByVal transactionChainRecord As CHCCommonLibrary.AreaCommon.Models.General.IdentifyLastTransaction) As Boolean
                Try
                    ...
                    If proceed Then
                        proceed = AreaCommon.state.runtimeState.updateChainProperty(value.common.chainReferement, AreaCommon.DAO.DBChain.DetailPropertyID.lastTransactionBlock, value.content, hashContent, transactionChainRecord)
                    End If
                    If proceed Then
                    ...
                    End If
                    If proceed Then
                        proceed = IOFast(Of EssentialA1x8).save(completefileName, value.content)
                    End If
        ...
        Public Class FormalCheck
            ...
            Shared Function verify(ByVal requestHash As String) As Nullable(Of Boolean)
                Try
                    ...
                    End If
                    If proceed Then
                        proceed = (request.content.dataLastRecord.coordinate.Length > 0)
                    End If
                    If proceed Then
        ...
        Public Class Manager
            ...
            ''' </summary>
            ''' <returns></returns>
            Shared Function addIntoLedger(ByVal approverPublicAddress As String, ByVal consensusHash As String, ByVal registrationTimeStamp As String, ByVal value As EssentialA1x8, ByVal requesterPublicAddress As String, ByVal requestHash As String) As CHCCommonLibrary.AreaCommon.Models.General.IdentifyLastTransaction
                Try
                    ...
                    AreaCommon.log.track("A1x8.Manager.addIntoLedger", "Begin")

                    contentPath = IO.Path.Combine(contentPath, hash & ".Content")

                    If IOFast(Of EssentialA1x8).save(contentPath, value) Then
                ...
                Catch ex As Exception
                    ...
                    AreaCommon.log.track("A1x8.Manager.addIntoLedger", ex.Message, "fatal")

                    Return New CHCCommonLibrary.AreaCommon.Models.General.IdentifyLastTransaction
                Finally
                    AreaCommon.log.track("A1x8.Manager.addIntoLedger", "Completed")
                End Try
            End Function
