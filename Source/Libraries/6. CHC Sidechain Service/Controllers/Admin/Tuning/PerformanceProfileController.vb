...
Namespace Controllers
    ...
    Public Class PerformanceProfileController
        ...
        Public Function GetValue(ByVal securityToken As String) As PerformanceProfileListResponseModel
            ...
            Try
                If (AreaCommon.Main.serviceInformation.currentStatus = InternalServiceInformation.EnumInternalServiceState.started) Then
                    AreaCommon.Main.environment.log.trackEnter("PerformanceProfileController.GetValue", ownerId,, CHCModelsLibrary.AreaModel.Log.AccessTypeEnumeration.api)
            ...
            Finally
                If enter Then
                    AreaCommon.Main.environment.log.trackExit("PerformanceProfileController.GetValue", ownerId)
                End If
            End Try
        ...
        Public Function PutValue(ByVal securityToken As String) As BaseRemoteResponse
            ...
            Try
                If (AreaCommon.Main.serviceInformation.currentStatus = InternalServiceInformation.EnumInternalServiceState.started) Then
                    AreaCommon.Main.environment.log.trackEnter("PerformanceProfileInstance.PutValue", ownerId, $"token={securityToken}", CHCModelsLibrary.AreaModel.Log.AccessTypeEnumeration.api)
            ...
            Finally
                If enter Then
                    AreaCommon.Main.environment.log.trackExit("PerformanceProfileInstance.PutValue", ownerId)
                End If
            End Try
