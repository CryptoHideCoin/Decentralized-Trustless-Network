...
Namespace Controllers
    ...
    Public Class TestController
        ...
        Public Function GetValue() As BaseRemoteResponse
            ...
            Try
                AreaCommon.Main.environment.log.trackEnter("Service.Test.GetValue", ownerId,, CHCModelsLibrary.AreaModel.Log.AccessTypeEnumeration.api)
            ...
            Finally
                If enter Then
                    AreaCommon.Main.environment.log.trackExit("Service.Test.GetValue", ownerId)
                End If
            End Try
