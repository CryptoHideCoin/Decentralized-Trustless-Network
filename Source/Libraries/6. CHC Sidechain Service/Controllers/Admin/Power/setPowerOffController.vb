        ...
        Public Function PutValue(ByVal securityToken As String) As BaseRemoteResponse
            ...
            Try
                If (AreaCommon.Main.serviceInformation.currentStatus = InternalServiceInformation.EnumInternalServiceState.started) Then
                    AreaCommon.Main.environment.log.trackEnter("SetPowerOff.PutValue", ownerId,, CHCModelsLibrary.AreaModel.Log.AccessTypeEnumeration.api)
            ...
            Finally
                If enter Then
                    AreaCommon.Main.environment.log.trackExit("SetPowerOff.PutValue", ownerId)
                End If
            End Try
