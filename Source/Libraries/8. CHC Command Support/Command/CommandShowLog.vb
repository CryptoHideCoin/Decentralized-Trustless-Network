...
Namespace AreaCommon.Command
    ...
    ''' </summary>
    Public Class CommandShowLog : Implements Models.CommandModel
        ...
        Private Function CommandModel_run() As Boolean Implements Models.CommandModel.run
            Try
                ...
                If IO.Directory.Exists(path) Then
                    ...
                    Else
                        RaiseEvent Process(path, $"-stream {parameterService} {parameterDataPath} {parameterPassword} {parameterMode} {parameterAddress} {parameterSecurityKey} {parameterPause}")
