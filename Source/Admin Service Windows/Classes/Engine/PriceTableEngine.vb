    ...
    Public Class PriceTableEngine
        ...
        Public Function init() As Boolean
            ...
            Try
                ...
                For Each singleFile In IO.Directory.GetFiles(AreaCommon.paths.transactionChain.defines.pricesList)
        ...
        Public Function getData(ByVal id As String) As AreaCommon.Models.Define.PriceTableResponseModel
            ...
            Try
                ...
                If _Keys.ContainsKey(id) Then
                    ...
                    pathFile = IO.Path.Combine(AreaCommon.paths.transactionChain.defines.pricesList, id & ".Definition")
