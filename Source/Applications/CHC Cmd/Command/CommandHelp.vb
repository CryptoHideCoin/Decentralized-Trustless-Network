...
Namespace AreaCommon.Command
    ...
    Public Class CommandHelp : Implements CommandModel
        ...
        Private Function CommandModel_run() As Boolean Implements CommandModel.run
            ...
            Console.WriteLine("   --address:                        Set an a complete address")
            Console.WriteLine("-showJournal                         Show a journal of a service")
            Console.WriteLine("   --service:                        Set a service name")
            Console.WriteLine("   --dataPath:                       Set a data path")
            Console.WriteLine("   --date:                           Set a date of a journal")
            Console.WriteLine("   --password:                       Set a password to decode settings file")
            Console.WriteLine("   --securityKey:                    Set a password of a security key")
            Console.WriteLine("   --address:                        Set an a complete address")
            ...
            Console.WriteLine("   --password:                       Set a password to decode settings file")
            Console.WriteLine("   --securityKey:                    Set a password of a security key")
            Console.WriteLine("-getPerformanceProfile               Get a performance profile")
            Console.WriteLine("   --service:                        Set a service name")
            Console.WriteLine("   --dataPath:                       Set a data path")
            Console.WriteLine("   --password:                       Set a password to decode settings file")
            Console.WriteLine("   --securityKey:                    Set a password of a security key")
            Console.WriteLine("-startPerformanceProfile             Start performance profile")
            Console.WriteLine("   --service:                        Set a service name")
            Console.WriteLine("   --dataPath:                       Set a data path")
            Console.WriteLine("   --password:                       Set a password to decode settings file")
            Console.WriteLine("   --securityKey:                    Set a password of a security key")
            Console.WriteLine("-testRAWServe                        Test a server response with RAW response")
            Console.WriteLine("   --address:                        Set the address")
