...
Namespace Controllers
    ...
    Public Class CleanLogController
        ...
        Public Function PutValue(ByVal securityToken As String) As BaseRemoteResponse
            Dim ownerId As String = "CleanLog-" & Guid.NewGuid.ToString
            ...
            Try
                If (AreaCommon.Main.serviceInformation.currentStatus = InternalServiceInformation.EnumInternalServiceState.started) Then
                    AreaCommon.Main.environment.log.trackEnter("CleanLog.PutValue", ownerId,, CHCModelsLibrary.AreaModel.Log.AccessTypeEnumeration.api)
            ...
            Finally
                If enter Then
                    AreaCommon.Main.environment.log.trackExit("CleanLog.PutValue", ownerId)
                End If
            End Try
