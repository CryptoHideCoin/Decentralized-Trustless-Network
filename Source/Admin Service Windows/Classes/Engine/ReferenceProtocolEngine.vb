    ...
    Public Class ReferenceProtocolEngine
        ...
        Public Function init() As Boolean
            ...
            Try
                ...
                For Each singleFile In IO.Directory.GetFiles(AreaCommon.paths.transactionChain.defines.referenceProtocols)
        ...
        Public Function getData(ByVal id As String) As AreaCommon.Models.Define.ReferenceProtocolResponseModel
            ...
            Try
                ...
                If _Keys.ContainsKey(id) Then
                    ...
                    pathFile = IO.Path.Combine(AreaCommon.paths.transactionChain.defines.referenceProtocols, id & ".Definition")
