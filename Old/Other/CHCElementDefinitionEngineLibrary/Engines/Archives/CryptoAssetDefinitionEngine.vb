...
Namespace CHCEngines
    ...
    Public Class CryptoAssetDefinitionEngine
        ...
        Public Function getUsedList(Optional ByVal useLogEngineAccess As Boolean = False, Optional adapterLog As CHCServerSupport.Support.LogEngine = Nothing) As List(Of String)
            ...
            trackLog("CryptoAssetDefinitionEngine.getUsedList", "Begin", , adapterLog)
            ...
            Catch ex As Exception
                ...
                trackLog("CryptoAssetDefinitionEngine.getUsedList", "Error:" & ex.Message, "Fatal", adapterLog)

            End Try

            trackLog("CryptoAssetDefinitionEngine.getUsedList", "Complete", , adapterLog)
