        ...
        Public Function GetValue(ByVal signature As String) As ResponseRequestAccessKeyModel
            ...
            Try
                If (AreaCommon.Main.serviceInformation.currentStatus = InternalServiceInformation.EnumInternalServiceState.started) Then
                    AreaCommon.Main.environment.log.trackEnter("RequestAccessKey.GetValue", ownerId,, CHCModelsLibrary.AreaModel.Log.AccessTypeEnumeration.api)
            ...
            Finally
                If enter Then
                    AreaCommon.Main.environment.log.trackExit("RequestAccessKey.GetValue", ownerId, result.accessKey)
                End If
            End Try
