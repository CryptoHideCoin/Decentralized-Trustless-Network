...
Partial Class MultipleBot
    ...
    Private Sub InitializeComponent()
        ...
        Me.productList.Items.AddRange(New Object() {"BTC-USDT", "ETH-USDT", "ADA-USDT", "SOL-USDT", "DOT-USDT", "DOGE-USDT", "AVAX-USDT", "MATIC-USDT", "SHIB-USDT", "LINK-USDT", "CRO-USDT", "ATOM-USDT", "ENJ-USDT", "XLM-USDT", "AXS-USDT", "CHZ-USDT", "STX-USDT", "QNT-USDT", "ZEN-USDT", "IMX-USDT", "PERP-USDT", "ENS-USDT", "DESO-USDT", "SPELL-USDT", "GALA-USDT", "SUPER-USDT", "FET-USDT", "LRC-USDT", "CLV-USDT", "POLY-USDT", "ORN-USDT", "RAD-USDT", "ALCX-USDT", "BOND-USDT", "TRAC-USDT"})
